...
public class SubsystemParsingTestCase extends AbstractSubsystemTest {
    ...
    public void testParseSubsystem() throws Exception {
        ...
        String subsystemXml =
                "<subsystem xmlns=\"" + CdiiExtension.NAMESPACE + "\">" +
                        "</subsystem>";
        ...
        Assert.assertEquals(CdiiExtension.SUBSYSTEM_NAME, element.getValue());
    }
    ...
    public void testInstallIntoController() throws Exception {
        ...
        Assert.assertTrue(model.get(SUBSYSTEM).hasDefined(CdiiExtension.SUBSYSTEM_NAME));
    }
    ...
    public void testDescribeHandler() throws Exception {
        ...
        describeOp.get(OP_ADDR).set(
                PathAddress.pathAddress(
                        PathElement.pathElement(SUBSYSTEM, CdiiExtension.SUBSYSTEM_NAME)).toModelNode());
